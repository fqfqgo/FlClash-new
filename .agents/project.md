...
- Dart SDK constraint in `pubspec.yaml`: `>=3.10.0 <4.0.0`. `freezed ^4.0.1`
  needs Dart `>=3.13.0` at resolve time; use the CI Flutter pin locally when
  running `flutter pub get` / analyze / test.
